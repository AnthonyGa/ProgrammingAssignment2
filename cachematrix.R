## The two functions below are used to calculate the inverse of a matrix, ...
## ... to store it in the cache and return the cached value when called again, ...
## ... in order to avoid repeating time consuming calculations.
...
## Afterwards, if matrix object isn't changed using setMatrix (would re initialise the cache) ...
